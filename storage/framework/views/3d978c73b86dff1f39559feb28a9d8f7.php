...
<div class="cycle_section layout_padding">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="box_main">
                        ...
                        <div class="image_2"><img src="<?php echo e(asset('images/img-2.png')); ?>"></div>
                     </div>
                  </div>
                  <div class="col-md-6">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="box_main_3">
                        ...
                        <div class="image_2"><img src="<?php echo e(asset('images/img-3.png')); ?>"></div>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="box_main_3">
                        ...
                        <div class="image_2"><img src="<?php echo e(asset('images/img-4.png')); ?>"></div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     ...
                     <div class="client_main">
                        ...
                        <div class="client_section_2">
                           <div class="client_left">
                              <div><img src="<?php echo e(asset('images/client-img.png')); ?>" class="client_img"></div>
                           </div>
                           <div class="client_right">
                              <div class="quote_icon"><img src="<?php echo e(asset('images/quote-icon.png')); ?>"></div>
               ...
               <div class="row">
                  <div class="col-sm-4">
                     <div class="box_main_1">
                        <div class="zoomout frame"><img src="<?php echo e(asset('images/img-6.png')); ?>"></div>
                  ...
                  <div class="col-sm-4">
                     <div class="box_main_1">
                        <div class="zoomout frame"><img src="<?php echo e(asset('images/img-7.png')); ?>"></div>
                        <div class="padding_15">
                           <h2 class="speed_text">Speed cycle</h2>
                           <div class="post_text">Post by : Den <span style="float: right;">20-12-2019</span></div>
                           <p class="long_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using </p>
                  ...
                  <div class="col-sm-4">
                     <div class="box_main_1">
                        <div class="zoomout frame"><img src="<?php echo e(asset('images/img-8.png')); ?>"></div>
                        <div class="padding_15">
      ...
      <!-- news section end -->
      <?php /**PATH C:\xamppeighttwo\htdocs\laravel\ass-os-module-15\resources\views/component/welcomemain.blade.php ENDPATH**/ ?>